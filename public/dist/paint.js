...
function createElement(parentQuery, elementInput) {
  ...
  if (
    ((_a = elementInput === null || elementInput === void 0
            ? void 0
            : elementInput.innerProps) === null || _a === void 0
      ? void 0
      : _a.classList)
...
class ColorTool extends Tool {
  ...
  addColor(elementInput) {
    ...
    const color = (_a = elementInput.style) === null || _a === void 0
      ? void 0
      : _a.background;
    if (color) {
...
class DrawingItemTool extends Tool {
  ...
  addItem(url, elementInput) {
    var _a;
    if (
      !((_a = elementInput.innerProps) === null || _a === void 0
        ? void 0
        : _a.id)
    ) {
      throw AppError.new(
    ...
    itemElement.addEventListener(
      "click",
      this.haldleOnClick(item, itemElement.id, url),
    );
  }
}
  ...
  addSize(elementInput) {
    ...
    const size_item = createElement(`#${this.props.id}`, {
      ...
      style: {
        ...
        left: (_b = elementInput.style) === null || _b === void 0
          ? void 0
          : _b.left,
        height: "100%",
      },
